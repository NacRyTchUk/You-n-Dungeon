...
//Логика работы анимации загрузочного экрана
var
  screenProp: real;
begin
  inc(AnimCounter);
...
//Проверка флагов для отладочных работ
begin
...
procedure GameSound(sName: string; isPlay: BOOL);
//Воспроизведение звуков и музыки в игре
var
  I: Integer;
begin
  for I := 1 to SFX_COUNT do
...
//Таймер, необходимый для корректного старта программы
begin
  LoadGameData();
